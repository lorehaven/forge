...
ui_scan_subtitle = Lint, ungenutzte Abhängigkeiten, bekannte Schwachstellen und Testabdeckung, aus dem letzten Lauf.
ui_scan_lint_title = Lint
ui_scan_machete_title = Ungenutzte Abhängigkeiten
ui_scan_audit_title = Schwachstellen
ui_scan_coverage_title = Testabdeckung
ui_scan_no_runs = Dieses Repository wurde noch nicht ausgeführt.
ui_scan_no_checks = Der letzte Lauf hat weder lint, machete, audit noch coverage ausgeführt. Füge `anvil lint`, `anvil machete`, `anvil audit` oder einen `cargo llvm-cov`-Schritt in .conveyor.toml hinzu, um sie hier zu sehen.
