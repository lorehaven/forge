...
ui_chat_attach_tooltip = Adjuntar un archivo (imágenes, pdf, txt, csv, md, html, json, yaml, código fuente…)
...
api_error_unsupported_file_type = Tipo de archivo no compatible. Permitidos: imágenes (png, jpg, webp, gif), pdf, txt, csv, md, html, json, yaml, toml, xml y archivos de código fuente comunes
api_error_image_not_processable = Las imágenes no se indexan para búsqueda; se envían directamente al modelo con tu mensaje
