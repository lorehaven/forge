...
ui_chat_attach_tooltip = Joindre un fichier (images, pdf, txt, csv, md, html, json, yaml, code source…)
...
api_error_unsupported_file_type = Type de fichier non pris en charge. Autorisés : images (png, jpg, webp, gif), pdf, txt, csv, md, html, json, yaml, toml, xml et fichiers de code source courants
api_error_image_not_processable = Les images ne sont pas indexées pour la recherche ; elles sont envoyées directement au modèle avec votre message
