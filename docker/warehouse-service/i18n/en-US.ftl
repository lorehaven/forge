...
ui_storage_files_truncated = This storage has more files than the browser can show.
...
ui_browse_open = Browse files
ui_file_preview_none = No preview available for this file type.
