...
ui_storage_files_truncated = Ten magazyn zawiera więcej plików, niż może wyświetlić przeglądarka.
...
ui_file_delete = Usuń
ui_browse_open = Przeglądaj pliki
ui_file_preview_none = Podgląd niedostępny dla tego typu pliku.
