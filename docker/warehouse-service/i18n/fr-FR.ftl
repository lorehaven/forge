...
ui_storage_files_truncated = Ce stockage contient plus de fichiers que l’explorateur ne peut afficher.
...
ui_browse_open = Parcourir les fichiers
ui_file_preview_none = Aucun aperçu disponible pour ce type de fichier.
